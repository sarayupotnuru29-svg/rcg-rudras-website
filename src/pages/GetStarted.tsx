...
const GetStarted = () => {
  return (
    <Layout>
      {/* Hero Section - Adjusted padding-top (pt) to move section up */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-secondary to-navy-dark pt-10 pb-16 md:pt-12 md:pb-24">
            ...
            <div className="text-center lg:text-left lg:pt-4">
              ...
              <div className="space-y-4 max-w-lg mx-auto lg:mx-0">
                {[
                  ...
                  "Personalized 1:1 mentorship from experienced industry experts",
                  "Complimentary access to integrated hands-on lab environments",
                ].map((item, index) => (
                  <div
                    key={index}
