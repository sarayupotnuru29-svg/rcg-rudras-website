...
import heroBgImage from "@/assets/homebg.jpeg";
    ...
    <Layout>
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Adjusted overlay opacity for better text contrast with the image */}
          <div className="absolute inset-0 bg-[#0a192f]/90 backdrop-blur-[1px]" />
        </div>
